                        ...
                        <?php foreach ($select as $sl) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Tombol edit -->
                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleedit<?= $sl["id"]; ?>">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="proses/proses_delete.php?id=<?= $sl["id"]; ?>" type="button" class="btn btn-primary">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <form action="proses/proses_edit.php" method="POST">
                            <div class="mb-1">
                                ...
                                <input type="text" name="id" value="<?= $sl["id"]; ?>" class="form-control" id="id" readonly>
                            </div>
                            <div class="mb-1">
