                                                ...
                                                <div class="col">
                                                    <div class="form-floating mb-2">
                                                        <input type="text" class="form-control" name="kelas"
                                                            id="floatingPassword" maxlength="2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" class="btn btn-primary" name="detail"
                                            ...
                                            <button type="button" class="btn btn-warning ms-2" name="edit"
                                                    ...
                                                    <form action="proses/proses_edit_mahasiswa.php" method="POST"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="form-floating mb-2">
                                                                    <input type="text" class="form-control" name="nama"
                                                                        id="floatingInput" value="<?= $query['nama'] ?>"
                                                                        autofocus>
                                                                    <label for="floatingInput">Nama</label>
                                                                </div>
                                                            </div>
